...
function Navbar() {
  ...
  // React Router's useNavigate hook for redirecting
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "ankurdhattarwal@gmail.com" ? (
                    <div className="flow-root">
                   ...
                   <div className="flow-root">
                    <Link to={'/about'} style={{ color: mode === 'dark' ? 'white' : '', }} className="-m-2 block p-2 font-medium text-gray-900">
                      About
                    </Link>
                  </div>
                  <div className="flow-root">
                    <Link to={'/contact'} style={{ color: mode === 'dark' ? 'white' : '', }} className="-m-2 block p-2 font-medium text-gray-900">
                      Contact Us
                    </Link>
                  </div>
                  {user ? (
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <h1 className='text-2xl font-bold text-black px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>Mytalorzone By Sahiba</h1>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to={'/cart'} className="group -m-2 flex items-center p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6 flex-shrink-0 text-gray-400">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3h16.5l-1.5 13.5H5.25L3.75 3zM9 16.5v1.125a2.625 2.625 0 105.25 0V16.5" />
                    </svg>
